...
(1, 'Entrantes', 'entrantes-neon.webp'),
(2, 'Cocktails', 'cocktails-neon.webp'),
(3, 'Principales', 'principales-neon.webp'),
(4, 'Extras', 'extras-neon.webp');
...
(1, 1, 'Nachos Vice', 'Nachos con queso cheddar, jalapeños y guacamole casero.', '12.50', 'nachos.webp'),
(2, 1, 'Alitas Neon', 'Alitas de pollo con salsa barbacoa picante.', '10.00', 'wings.webp'),
(3, 2, 'Miami Mule', 'Vodka, lima, cerveza de jengibre y menta.', '9.00', 'mule.webp'),
(4, 2, 'Sunset Vice', 'Ron, piña, coco y granadina.', '9.50', 'sunset.webp'),
(6, 3, 'Vice Burger', 'Hamburguesa premium con queso cheddar, bacon crujiente, cebolla caramelizada y salsa especial Vice.', '16.50', 'burger.webp'),
(7, 3, 'Miami Ribs', 'Costillas BBQ glaseadas con salsa de miel y especias, acompañadas de patatas rústicas.', '22.00', 'ribs.webp'),
(8, 3, 'Neon Tacos', 'Tres tacos de carne asada con guacamole, pico de gallo y queso fundido.', '14.50', 'tacos.webp'),
(9, 4, 'Cachimba Premium', 'Shisha de lujo con una manguera, sabores premium a elección y base iluminada.', '25.00', 'shisha1.webp'),
(10, 4, 'Cachimba VIP Duo', 'Shisha exclusiva de dos mangueras, cuerpo dorado y tabaco reserva especial.', '40.00', 'shisha2.webp'),
(11, 4, 'Champagne Vice Luminous', 'Botella francesa premium con etiqueta luminosa, servida con bengalas y cubitera led.', '120.00', 'champagne.webp'),
(18, 1, 'Quesadillas Glow', 'Tres quesadillas de trigo rellenas de queso fundido, carne especiada y salsa chipotle neón.', '10.00', 'quesadillas.webp'),
(19, 2, 'Blue Lagoon', 'Vodka premium, Blue Curaçao, limonada casera y una cereza marrasquino brillante.', '9.00', 'lagoon.webp');
